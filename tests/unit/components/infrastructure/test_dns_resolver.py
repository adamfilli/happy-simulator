...
class TestDNSResolverBehavior:
    ...
    def test_resolve_known_record(self):
        ...
        dns, _sim = self._make_dns(records=records)
    ...
    def test_add_record(self):
        ...
        _values, ip = self._exhaust(dns.resolve("new.com"))
        assert ip == "5.5.5.5"

    def test_cache_eviction(self):
        records = {f"host{i}.com": DNSRecord(f"host{i}.com", f"10.0.0.{i}") for i in range(5)}
        dns, _sim = self._make_dns(records=records, cache_capacity=3)
